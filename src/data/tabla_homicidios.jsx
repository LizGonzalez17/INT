...
const TablaHomicidios = () => {
  ...
  return (
    <div style={styles.contenedor}>
      <h3 style={styles.titulo}>Formulario de Denuncia - Homicidios</h3>
      <form onSubmit={handleSubmit} style={styles.formulario}>
        ...
        <div style={styles.campo}>
          ...
          <textarea
            name="descripcionesFisicas"
            value={formData.descripcionesFisicas}
            onChange={handleChange}
            required
            style={styles.textarea}
          />
...
export default TablaHomicidios;