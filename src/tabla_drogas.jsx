...
const TablaDrogas = () => {
  const [formData, setFormData] = useState({
    ...
    descripcion: '',
    descripcionFisicas: '',
    tipoDroga: '', // Campo vacío para seleccionar tipo de droga
    descripcionVehiculo: '',
  ...
  return (
    <div style={styles.contenedor}>
      <h3 style={styles.titulo}>Formulario de Denuncia - Tabla Drogas</h3>
      <form onSubmit={handleSubmit} style={styles.formulario}>
        ...
        <div style={styles.campo}>
          <label style={styles.label}>Descripciones físicas:</label>
          <textarea
            name="descripcionFisicas"
            value={formData.descripcionFisicas}
            onChange={handleChange}
            required
            style={styles.textarea}
          />
        ...
        {/* Tipo de droga */}
        <div style={styles.campo}>
          <label style={styles.label}>Tipo de droga:</label>
          <select
            name="tipoDroga"
            ...
            style={styles.select}
          >
            <option value="">Seleccione tipo de droga</option>
          </select>
        </div>
        ...
        {/* Pruebas */}
        <div style={styles.campo}>
          <label style={styles.label}>Pruebas:</label>
          <textarea
            name="pruebas"
