...
const TablaServiciosPublicos = () => {
  ...
  return (
    <div style={styles.contenedor}>
      <h3 style={styles.titulo}>Formulario de Denuncia - Servicios Públicos</h3>
...
export default TablaServiciosPublicos;
