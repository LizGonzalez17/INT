...
const TablaDesastresNaturales = () => {
  ...
  return (
    <div style={styles.contenedor}>
      <h3 style={styles.titulo}>Formulario de Denuncia - Desastres Naturales</h3>
      <form onSubmit={handleSubmit} style={styles.formulario}>
        ...
        {/* Tipo de desastre */}
        <div style={styles.campo}>
          <label style={styles.label}>Tipo de desastre:</label>
          <select
            name="tipoDesastre"
            ...
            style={styles.select}
          >
            <option value="">Seleccione tipo de desastre</option>
          </select>
        </div>
...
export default TablaDesastresNaturales;